...
public class AbstractTinygDriver extends Observable implements TinygDriver {
...
//        }
        ...
        if (getMachine().getFirmwareBuildValue() < getHardwarePlatform().getMinimalBuildVersion() && 
...
//              machine.setMotionMode(Integer.valueOf(rc.getSettingValue()));
    ...
    private static class TinygDriverHolder {
        private static final TinygDriver INSTANCE = TinygDriverFactory.getTinygDriver();
    }
